...
const cards = [
  {
    ...
    image: `${process.env.NODE_ENV === 'production' ? '/Academy-Dashboard-Carousel' : ''}/DMR.jpeg?height=200&width=300`,
  ...
  },
  {
    ...
    image: `${process.env.NODE_ENV === 'production' ? '/Academy-Dashboard-Carousel' : ''}/event-portal.jpeg?height=200&width=300`,
  ...
  },
  {
    ...
    image: `${process.env.NODE_ENV === 'production' ? '/Academy-Dashboard-Carousel' : ''}/PLM-TTT.jpeg?height=200&width=300`,
  ...
  },
  {
    ...
    image: `${process.env.NODE_ENV === 'production' ? '/Academy-Dashboard-Carousel' : ''}/topic-linkedin.png?height=200&width=300`,
  ...
  },
  {
   ...
   image: `${process.env.NODE_ENV === 'production' ? '/Academy-Dashboard-Carousel' : ''}/ttt-ep.jpeg?height=200&width=300`,
